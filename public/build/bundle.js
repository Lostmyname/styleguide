...
},{"../../node_modules/lmn.jester.component.collapsible/src/js/jester.component.collapsible":8,"../../node_modules/lmn.jester.component.gallery/src/js/gallery-simple":10,"../../node_modules/lmn.jester.component.swiper/src/js/jester.component.swiper":13,"../../node_modules/lmn.jester.component.tab/src/js/jester.component.tab":15,"../../node_modules/lmn.jester.component.video/src/js/jester.component.video":16,"codemirror":2,"codemirror/mode/htmlmixed/htmlmixed":4,"codemirror/mode/javascript/javascript":5,"codemirror/mode/xml/xml":6,"jquery":7}],2:[function(require,module,exports){
...
window.Collapsible = module.exports = (function () {
  'use strict';
  ...
  function Component(el) {
    ...
    this.$el.find('.collapsible-toggle').click(function () {
      that.toggle();
    });
  }

  /**
   * Toggle the element's content
   */
  Component.prototype.toggle = function () {
    console.log('toggle');
    this.$el.find('.collapsible-content').slideToggle();
  };
...
},{"/Users/barneyfox/Sites/styleguide/node_modules/jquery/dist/jquery.js":7}],10:[function(require,module,exports){
'use strict';
 ...
 *
 * @param {*} element Gallery element or selector. Something to pass to jQuery.
 */
gallery.init = function (element) {
  var $element = $(element);
  var $scroller = $element.find('.scroll-horizontal');

  var $queue = window.a = $({});

  $element.find('[data-key="gallery-left"]').css('opacity', 0);

  $element.on('click', '[data-key^="gallery-"]', function (e) {
    e.preventDefault();

    var goingLeft = $(this).data('key') === 'gallery-left';

    // Queue: if it's clicked multiple times, don't ignore them
    $queue.queue(function (next) {
      ...
      var maxScrollLeft = imagesWidth - $scroller.width();
      ...
      $scroller.find('img')
        .each(function () {
          if ($(this).position().left <= scrollLeft && scrollLeft <= $(this).position().left + $(this).width()) {

            // If position contains .5, it's partway across an element
            if ($(this).position().left < scrollLeft - 20) {
              position += 0.5;
            }
          ...
          // Consistent return points—ignore
          return true;
        });

      // If halfway across an element, scroll to either side of that element
      // instead of skipping one out
      if (position % 1 !== 0) {
        position = Math[goingLeft ? 'floor' : 'ceil'](position);
      } else {
        position += goingLeft ? -1 : 1;
      }
      ...
      // Ensure the scroller doesn't go further right than it actually can
      var $img = $element.find('img').eq(position);
      var newScrollLeft = $scroller.scrollLeft() + $img.offset().left;

      if (newScrollLeft > maxScrollLeft) {
        newScrollLeft = maxScrollLeft;
      }

      var duration = $queue.queue().length > 1 ? 200 : 400;
      $scroller.animate({ scrollLeft: newScrollLeft }, duration, next);

      $element.find('[data-key="gallery-left"]')
        .animate({ opacity: (newScrollLeft < 50) ? 0 : 1 }, duration);

      $element.find('[data-key="gallery-right"]')
        .animate({
          opacity: (newScrollLeft + 50 > maxScrollLeft) ? 0 : 1
        }, duration);
    });
  });
};

$.fn.gallerise = function () {
  this.each(function () {
    gallery.init(this);
  });
};
...
module.exports=require(7)
},{"/Users/barneyfox/Sites/styleguide/node_modules/jquery/dist/jquery.js":7}],12:[function(require,module,exports){
/*
 * Swiper 2.7.5
...
// Swiper is overkill for this but have used in the interest of speed
var Swiper = require('../../node_modules/swiper/dist/idangerous.swiper.min.js');

var swiper = module.exports = {};

swiper.initSwiper = function () {

  new Swiper('[data-key="swiper"]', {
    slidesPerView: 1,
...
},{"../../node_modules/swiper/dist/idangerous.swiper.min.js":12,"jquery":11}],14:[function(require,module,exports){
module.exports=require(7)
},{"/Users/barneyfox/Sites/styleguide/node_modules/jquery/dist/jquery.js":7}],15:[function(require,module,exports){
'use strict';
